...
/*   Updated: 2024/09/29 08:41:02 by edouard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_parser_handle_redirection(t_token **current_token, t_parser_data *data, t_command **last_command);
...
void ft_handle_command_token(t_token **current_token, t_parser_data *data, char *cmd_value_clean);
...
void handle_error_non_critical(char *cmd, char *error_message, int exit_code, t_shell *shell);
void handle_redirection_error(t_error_info error_info, t_shell *shell, int fd);
...
t_error_info init_error_info(char *filepath, char *error_message, int exit_code);
...
int handle_error_parsing(char *unexpected_token, t_parser_data *data, int exit_status, int return_status);
