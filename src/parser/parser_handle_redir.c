...
/*   Updated: 2024/09/26 15:36:29 by edouard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

int handle_redir_in(t_token **current_token, t_parser_data *data, t_command **last_command)
{
	char *token_value;
	char *file_name;
...
int handle_heredoc(t_token **current_token, t_parser_data *data, t_command *last_command)
{
	char *file_name;
...
int handle_redir_out(t_token **current_token, t_parser_data *data, t_command *last_command)
{
	char *token_value;
	char *file_name;
...
int handle_redir_append(t_token **current_token, t_parser_data *data, t_command *last_command)
{
	char *token_value;
	char *file_name;
